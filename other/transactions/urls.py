...
from other.transactions.transaction_list.views import TransactionListView
from other.transactions.transaction_add.views import TransactionAddView
from other.transactions.transaction_update.views import TransactionUpdateView
from other.transactions.transaction_delete.views import TransactionDeleteView
